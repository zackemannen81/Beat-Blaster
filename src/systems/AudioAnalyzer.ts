...
export default class AudioAnalyzer extends Phaser.Events.EventEmitter {
  ...
  private smoothing = 0.8  // Increased for more stable detection
  ...
  private computeBands(spectrum: Uint8Array): { low: number; mid: number; high: number } {
    ...
    // - Snare snap: 1-5kHz
    return {
      low: band(50, 150),      // Bass drum range
      mid: band(150, 350),     // Snare body
      high: band(1500, 8000)   // Snare snap and high frequencies
    }
  }
