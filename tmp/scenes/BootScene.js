...
export default class BootScene extends Phaser.Scene {
    ...
    makeThrusterPinkCanvas(key = 'thruster_pink', w = 64, h = 64) {
    ...
    preload() {
        ...
        this.load.atlas('gameplay', 'src/assets/sprites/gameplay.atlas.png', 'src/assets/sprites/gameplay.atlas.json');
        this.load.atlas('ui', 'src/assets/sprites/ui.atlas.png', 'src/assets/sprites/ui.atlas.json');
        this.load.atlas('particles', 'src/assets/sprites/particles.atlas.png', 'src/assets/sprites/particles.atlas.json');
        /*
        ...
        */
        ...
        const loadSequence = (prefix, count) => {
    ...
    create() {
        ...
        const tracks = this.cache.json.get('tracks');
    ...
    ensurePlasmaAnimations() {
        const makeFrames = (prefix, count) => Array.from({ length: count }, (_v, i) => ({ key: `${prefix}_${i}` }));
